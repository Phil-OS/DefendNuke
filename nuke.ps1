...
# Disable Defender Real-Time Protection features
...
# Disable Defender Enhanced Notifications
...
# Disable Defender Spynet features
...
# Disable Defender Scheduled Tasks (remove autoruns)
...
# Stop Windows Update Service and disable it
Stop-Service -Name wuauserv -Force
Set-Service -Name wuauserv -StartupType Disabled

# Disable Windows Update (NoAutoUpdate)
